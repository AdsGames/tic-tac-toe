...
void setup(bool first){
  ...
  if(first){
    ...
    //Sets button images
    one_player.SetImages("images/buttons/one_player.png","images/buttons/one_player_hover.png");
    two_player.SetImages("images/buttons/two_player.png","images/buttons/two_player_hover.png");
    quit.SetImages("images/buttons/quit.png","images/buttons/quit_hover.png");
    menu.SetImages("images/buttons/menu.png","images/buttons/menu_hover.png");
    sound.SetImages("images/buttons/sound_on.png","images/buttons/sound_on_hover.png");
    difficulty_b.SetImages("images/buttons/medium.png","images/buttons/medium_hover.png");
    ...
    menu.SetY(270);
    sound.SetY(250);
    difficulty_b.SetY(250);

    sound.SetWidth(30);
    sound.SetHeight(30);
    difficulty_b.SetWidth(30);
    difficulty_b.SetHeight(30);
  }
}
...
void gameOne(){
  ...
  for(int i=0; i<3; i++){
    for(int t=0; t<3; t++){
      selectedarray[i][t]=0;
      if((mouse_x/100)==i && (mouse_y/100)==t && menu.CheckHover()==false){
        selectedarray[i][t]=1;
        x=i;
        y=t;
      }
  ...
  if(mouse_b&1 && gridarray[x][y]==0){
    if(turn==0){
      gridarray[x][y]=1;
      if(soundfx==true)play_sample(place,255,122,1000,0);
      turn=1;
    }
  }
...
void gameTwo(){
  ...
  //Places x or o respectively
  if(mouse_b&1 && gridarray[x][y]==0 && menu.CheckHover()==false){
    if(turn==0){
      gridarray[x][y]=1;
      if(soundfx==true)play_sample(place,255,122,1000,0);
      turn=1;
      ...
      gridarray[x][y]=2;
      if(soundfx==true)play_sample(place,255,122,1500,0);
      turn=0;
  ...
  while( !key[KEY_ESC]){
    ...
    // Menu
      ...
      if(mouse_b&1){
        ...
        else if(two_player.CheckHover()==true){
          gameScreen = 3;
          cursor=load_bitmap( "images/cursor_x.png", NULL);
          setup(false);
          highcolor_fade_out(16);
        ...
        else if(difficulty_b.CheckHover()==true){
          if(difficulty==2){
            difficulty=0;
            difficulty_b.SetImages("images/buttons/easy.png","images/buttons/easy_hover.png");
            rest(160);
          }
            ...
            difficulty=2;
            difficulty_b.SetImages("images/buttons/hard.png","images/buttons/hard_hover.png");
            rest(160);
          }
        }
        else if(sound.CheckHover()==true){
          if(soundfx==true){
            soundfx=false;
            sound.SetImages("images/buttons/sound_off.png","images/buttons/sound_off_hover.png");
            rest(160);
          }
...
int main() {
  ...
  delete [] buffer, grid, X, O, blank, selected, xwin, owin, catsgame, win, lose, cat, place;
