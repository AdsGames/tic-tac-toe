  ...
  // One player and 2 player
    ...
    if(gridarray[0][0]==1 && gridarray[0][1]==1 && gridarray[0][2]==1||gridarray[1][0]==1 && gridarray[1][1]==1 && gridarray[1][2]==1||gridarray[2][0]==1 && gridarray[2][1]==1 && gridarray[2][2]==1||gridarray[0][0]==1 && gridarray[1][0]==1 && gridarray[2][0]==1||gridarray[0][1]==1 && gridarray[1][1]==1 && gridarray[2][1]==1||gridarray[0][2]==1 && gridarray[1][2]==1 && gridarray[2][2]==1||gridarray[0][0]==1 && gridarray[1][1]==1 && gridarray[2][2]==1||gridarray[2][0]==1 && gridarray[1][1]==1 && gridarray[0][2]==1) {
      if(gridarray[0][0]==1 && gridarray[0][1]==1 && gridarray[0][2]==1)
        aexlib::draw::primitive::thick_line(buffer, 50, 50, 50, 250, 10, makecol(255,0,0));
      if(gridarray[1][0]==1 && gridarray[1][1]==1 && gridarray[1][2]==1)
        aexlib::draw::primitive::thick_line(buffer, 150, 50, 150, 250, 10, makecol(255,0,0));
      if(gridarray[2][0]==1 && gridarray[2][1]==1 && gridarray[2][2]==1)
				aexlib::draw::primitive::thick_line(buffer, 250, 50, 250, 250, 10, makecol(255,0,0));
      if(gridarray[0][0]==1 && gridarray[1][0]==1 && gridarray[2][0]==1)
				aexlib::draw::primitive::thick_line(buffer, 50, 50, 250, 50, 10, makecol(255,0,0));
      if(gridarray[0][1]==1 && gridarray[1][1]==1 && gridarray[2][1]==1)
				aexlib::draw::primitive::thick_line(buffer, 50, 150, 250, 150, 10, makecol(255,0,0));
      if(gridarray[0][2]==1 && gridarray[1][2]==1 && gridarray[2][2]==1)
				aexlib::draw::primitive::thick_line(buffer, 50, 250, 250, 250, 10, makecol(255,0,0));
      if(gridarray[0][0]==1 && gridarray[1][1]==1 && gridarray[2][2]==1)
				aexlib::draw::primitive::thick_line(buffer, 50, 50, 250, 250, 10, makecol(255,0,0));
      if(gridarray[2][0]==1 && gridarray[1][1]==1 && gridarray[0][2]==1)
				aexlib::draw::primitive::thick_line(buffer, 250, 50, 50, 250, 10, makecol(255,0,0));
